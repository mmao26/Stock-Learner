...
def compute_portvals(orders_file, start_val = 100000):
    ...
    start_date = dt.datetime(2010,1,1) #orders_df.index[0]
    end_date = dt.datetime(2011,12,31) #orders_df.index[-1]
...
def test_code():
    ...
    of1 = "./orders-rule-outsample.csv"
    of2 = "./orders-ML-outsample.csv"
    sv = 100000
